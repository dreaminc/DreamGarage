...
bool	Logger::InitializeLogger()
{
	...
	defaultConf.set(el::Level::Info, el::ConfigurationType::Format, "%datetime %thread [DOSLAUNCHER] %level %msg");
	defaultConf.set(el::Level::Error, el::ConfigurationType::Format, "%datetime %thread [DOSLAUNCHER] %level %msg");

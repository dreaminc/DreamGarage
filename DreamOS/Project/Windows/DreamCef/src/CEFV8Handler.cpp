...
RESULT CEFV8Handler::Initialize() {
	...
	CR(RegisterExtensionFunction("isInputFocused", std::bind(&CEFV8Handler::HandleDreamFormIsInputFocused, this, std::placeholders::_1, std::placeholders::_2)));
...
RESULT CEFV8Handler::HandleDreamFormIsInputFocused(CefRefPtr<CefBrowser> browser, const CefV8ValueList& CefArguments) {
	RESULT r = R_PASS;
	CefRefPtr<CefProcessMessage> pCEFProcessMessage = CefProcessMessage::Create("DreamCEFApp::DreamExtension");

	const CefString strType = "Browser";
	const CefString strMethod = "isInputFocused";
	CefRefPtr<CefListValue> cefProcessMessageArguments = pCEFProcessMessage->GetArgumentList();
	cefProcessMessageArguments->SetSize(3);

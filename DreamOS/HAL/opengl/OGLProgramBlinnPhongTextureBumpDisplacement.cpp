...
OGLProgramBlinnPhongTextureBumpDisplacement::OGLProgramBlinnPhongTextureBumpDisplacement(OpenGLImp *pParentImp) :
	OGLProgram(pParentImp, "oglblinnphongtexturebumpdisplacement"),

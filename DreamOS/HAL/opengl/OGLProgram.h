...
public:
	...
	RESULT SetStereoCamera(std::shared_ptr<stereocamera> pStereoCamera, EYE_TYPE eye);
	...
	virtual RESULT SetCameraUniforms(std::shared_ptr<stereocamera> pStereoCamera, EYE_TYPE eye) = 0;

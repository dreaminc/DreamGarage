...
void TestClientRenderer::Render() {
  ...
  //glVertexAttribPointer(ATTRIB_NORMAL, 3, GL_FLOAT, GL_FALSE, iStride,(const void*)(BUFFER_OFFSET(3 * sizeof(GLfloat))));
  glVertexAttribPointer(ATTRIB_NORMAL, 3, GL_FLOAT, GL_FALSE, iStride,(void*)(3 * sizeof(GLfloat)));

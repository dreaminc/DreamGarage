# In Release build, Dream root is set to the .exe location of Dream.
# This script is for a Post-build in Release for copying the necessary assets into the build folder.
